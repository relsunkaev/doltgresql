...
const (
	...
	oidInt4MultiRange      = uint32(4451)
	oidNumMultiRange       = uint32(4532)
	oidTsMultiRange        = uint32(4533)
	oidTstzMultiRange      = uint32(4534)
	oidDateMultiRange      = uint32(4535)
	oidInt8MultiRange      = uint32(4536)
	oidInt4MultiRangeArray = uint32(6150)
	oidNumMultiRangeArray  = uint32(6151)
	oidTsMultiRangeArray   = uint32(6152)
	oidTstzMultiRangeArray = uint32(6153)
	oidDateMultiRangeArray = uint32(6155)
	oidInt8MultiRangeArray = uint32(6157)
)
...
func init() {
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "_datemultirange"), oidDateMultiRangeArray)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "_int4multirange"), oidInt4MultiRangeArray)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "_int8multirange"), oidInt8MultiRangeArray)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "_nummultirange"), oidNumMultiRangeArray)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "_tsmultirange"), oidTsMultiRangeArray)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "_tstzmultirange"), oidTstzMultiRangeArray)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "datemultirange"), oidDateMultiRange)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "int4multirange"), oidInt4MultiRange)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "int8multirange"), oidInt8MultiRange)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "nummultirange"), oidNumMultiRange)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "tsmultirange"), oidTsMultiRange)
	...
	globalCache.setBuiltIn(NewId(Section_Type, "pg_catalog", "tstzmultirange"), oidTstzMultiRange)
