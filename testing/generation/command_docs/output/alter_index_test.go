...
func TestAlterIndex(t *testing.T) {
	tests := []QueryParses{
		...
		Converts("ALTER INDEX name RESET ( fillfactor )"),
		Converts("ALTER INDEX IF EXISTS name RESET ( fillfactor )"),
		Converts("ALTER INDEX name RESET ( fillfactor , fillfactor )"),
		Converts("ALTER INDEX IF EXISTS name RESET ( fillfactor , fillfactor )"),
		Converts("ALTER INDEX name ALTER 1 SET STATISTICS 1"),
		Converts("ALTER INDEX IF EXISTS name ALTER 1 SET STATISTICS 1"),
		Converts("ALTER INDEX name ALTER COLUMN 1 SET STATISTICS 1"),
		Converts("ALTER INDEX IF EXISTS name ALTER COLUMN 1 SET STATISTICS 1"),
