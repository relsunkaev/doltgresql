	...
	RunScripts(t, []ScriptTest{
		{
			...
			Assertions: []ScriptTestAssertion{
				...
				{
					Query: `SELECT relreplident FROM pg_catalog.pg_class WHERE relname = 'shapes';`, PostgresOracle: ScriptTestPostgresOracle{ID: "replica-identity-full-probe-test-testreplicaidentityfullprobe-0001-select-relreplident-from-pg_catalog.pg_class-where"},
				},
			},
		},
		{
			...
			Assertions: []ScriptTestAssertion{
				...
				{
					Query: `SELECT relreplident FROM pg_catalog.pg_class WHERE relname = 'other';`, PostgresOracle: ScriptTestPostgresOracle{ID: "replica-identity-full-probe-test-testreplicaidentityfullprobe-0002-select-relreplident-from-pg_catalog.pg_class-where"},
				},
			},
		},
	})
