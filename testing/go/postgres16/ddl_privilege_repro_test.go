			...
			Assertions: []ScriptTestAssertion{
				{
					...
					Password: `ctas`, PostgresOracle: ScriptTestPostgresOracle{ID: "ddl-privilege-repro-test-testcreatetableasrequiresschemacreateprivilegeguard-0001-create-table-as-select-id"},
				},
				{
