...
ORDER BY 1,2;`,
		...
		},
		{
			...
			Assertions: []ScriptTestAssertion{
				{
					Query: "ALTER TABLE public.test1 ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME public.test1_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1);", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0220-alter-table-public.test1-alter-column"},
				},
				{
					Query: "ALTER TABLE public.test2 ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME public.test2_id_seq START WITH 10 INCREMENT BY 5);", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0221-alter-table-public.test2-alter-column"},
				},
				{
					Query: "ALTER TABLE public.test3 ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME public.test3_id_seq START WITH 100 INCREMENT BY -1 MAXVALUE 100);", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0222-alter-table-public.test3-alter-column"},
				},
				{
					Query: "INSERT INTO public.test1 (name) VALUES ('abc'), ('def');", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0223-insert-into-public.test1-name-values"},
				},
				{
					Query: "INSERT INTO public.test2 (name) VALUES ('abc'), ('def');", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0224-insert-into-public.test2-name-values"},
				},
				{
					Query: "INSERT INTO public.test3 (name) VALUES ('abc'), ('def');", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0225-insert-into-public.test3-name-values"},
				},
				{
					Query: "SELECT * FROM public.test1;", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0226-select-*-from-public.test1"},
				},
				{
					Query: "SELECT * FROM public.test2;", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0227-select-*-from-public.test2"},
				},
				{
					Query: "SELECT * FROM public.test3;", PostgresOracle: ScriptTestPostgresOracle{ID: "sequences-test-testsequences-0228-select-*-from-public.test3"},
				},
			},
		},
		{
