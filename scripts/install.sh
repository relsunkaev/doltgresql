...
#
#   curl https://github.com/dolthub/doltgresql/releases/download/v__DOLTGRES_VERSION__/install.sh | sudo bash
#
...
DOLTGRES_RELEASE_REPO="${DOLTGRES_RELEASE_REPO:-dolthub/doltgresql}"
RELEASES_BASE_URL="${DOLTGRES_RELEASE_BASE_URL:-https://github.com/$DOLTGRES_RELEASE_REPO/releases/download/v$DOLTGRES_VERSION}"
