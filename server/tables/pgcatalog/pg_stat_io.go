...
func (p PgStatIoHandler) RowIter(ctx *sql.Context, partition sql.Partition) (sql.RowIter, error) {
	return sql.RowsToRowIter(sql.Row{
		...
		float64(0),       // read_time
		int64(0),         // writes
		float64(0),       // write_time
		int64(0),         // writebacks
		float64(0),       // writeback_time
		int64(0),         // extends
		float64(0),       // extend_time
		int64(8192),      // op_bytes
		int64(0),         // hits
		int64(0),         // evictions
		int64(0),         // reuses
		int64(0),         // fsyncs
		float64(0),       // fsync_time
		nil,              // stats_reset
	}), nil
}

// PkSchema implements the interface tables.Handler.
func (p PgStatIoHandler) PkSchema() sql.PrimaryKeySchema {
