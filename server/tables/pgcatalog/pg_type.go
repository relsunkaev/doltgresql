...
func pgTypeToRow(nextType *pgType) sql.Row {
	...
	return sql.Row{
		...
		nextType.typ.SubscriptFuncID(),                // typsubscript
		nextType.typ.Elem.AsId(),                      // typelem
		nextType.typ.Array.AsId(),                     // typarray
		nextType.typ.InputFuncID(),                    // typinput
		nextType.typ.OutputFuncID(),                   // typoutput
		nextType.typ.ReceiveFuncID(),                  // typreceive
		nextType.typ.SendFuncID(),                     // typsend
		nextType.typ.ModInFuncID(),                    // typmodin
		nextType.typ.ModOutFuncID(),                   // typmodout
		nextType.typ.AnalyzeFuncID(),                  // typanalyze
		...
		typAcl,                                        // typacl
		id.NewTable(PgCatalogName, pgTypeName).AsId(), // tableoid
	}
}
